<template>
  <div class="edit-period-page max-w-xl mx-auto p-6 bg-white rounded shadow">
    <h2 class="text-2xl font-bold mb-4">Edit Period</h2>
...
function handleSubmit() {
  ...
  successMessage.value = 'Period updated successfully!';
}
</script>
