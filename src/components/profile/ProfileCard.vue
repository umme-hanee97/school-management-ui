<template>
  <div class="bg-white rounded-lg shadow p-6 w-full max-w-md">
    <div class="flex items-center gap-4">
      <div class="w-20 h-20 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 text-2xl">{{ initials }}</div>
      <div>
    ...
    <div class="mt-4">
      ...
      <p class="text-sm text-gray-600">Role: <span class="font-medium">
    {{
      displayRole
    }}
  </span></p>
...
export default {
  ...
  computed: {
    ...
    if (this.user.roles.length === 1 && this.user.roles[0] === 'USER') {
      return 'User'
    }
